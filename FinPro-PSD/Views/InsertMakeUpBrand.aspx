<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Layout.Master" AutoEventWireup="true" CodeBehind="InsertMakeUpBrand.aspx.cs" Inherits="FinPro_PSD.Views.InsertMakeUpBrand" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        ...
        <div>
            ...
            <asp:TextBox ID="RatingTbx" runat="server" TextMode="Number"></asp:TextBox>
        </div>
        <div>
